...
const RegisterShade = ({ setIsOpen }) => {
  return (
    <form className="my-3 flex flex-col gap-4 items-start justify-start">
      {/* first block */}
      <h2 className="text-[#3170B5] text-3xl font-bold">የአንቀሳቃሾች ብዛት</h2>
      <p className="text-sm  w-3/4 text-[#425466]">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor incididunt ut labore et magna aliqua.consectetur adipiscing elit,
      ...
      {/* second block */}
      <h2 className="text-[#3170B5] text-3xl font-bold">አድራሻ</h2>
      <p className="text-sm  w-3/4 text-[#425466]">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor incididunt ut labore et magna aliqua.consectetur adipiscing elit,
        sed do eiusmod tempor incididunt
